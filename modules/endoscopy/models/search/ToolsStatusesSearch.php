...
/**
 * ToolsStatuses represents the model behind the search form of `app\modules\endoscopy\models\ToolsStatuses`.
 *
 ...
 *
 */
class ToolsStatusesSearch extends ToolsStatuses
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'icon', 'comment', 'created_by', 'updated_by', ], 'safe'],
        ];
    }
