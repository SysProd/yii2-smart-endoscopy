...
/**
 * ToolsCleaningMachinesSearch represents the model behind the search form of `app\modules\endoscopy\models\ToolsCleaningMachines`.
 *
 ...
 *
 */
class ToolsCleaningMachinesSearch extends ToolsCleaningMachines
{
    ...
    {
        return [
            [['id', 'mode',], 'integer', 'on' => self::SCENARIO_SEARCH],
            ...
            [['name', 'comment', 'created_by', 'updated_by', ], 'safe'],
        ];
    }
