...
class Tools extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'],  'unique', 'targetClass' => $this::className(), 'message' => \Yii::t('app', 'This «{attribute}» has been added', ['attribute' => \Yii::t('app', 'Machined Tool')] )],
    ...
    {
        return $this->hasMany(CleaningLog::className(), ['tools_by' => 'id']);
    }
    ...
    {
        return $this->hasMany(RfidTags::className(), ['fx_tools' => 'id']);
    }
