...
/**
 * This is the model class for table "tools_statuses".
 *
 * @property int $id
 * @property string|null $name
 * @property string|null $icon Иконки Статуса
 ...
 * */
class ToolsStatuses extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'],  'unique', 'targetClass' => $this::className(), 'message' => \Yii::t('app', 'This «{attribute}» has been added', ['attribute' => \Yii::t('app', 'Instrument Status')] )],
    ...
    {
        return $this->hasMany(CleaningLog::className(), ['test_qualities_cleaning_status' => 'id']);
    }
    ...
    {
        return $this->hasMany(RfidTags::className(), ['fx_tools_statuses' => 'id']);
    }
