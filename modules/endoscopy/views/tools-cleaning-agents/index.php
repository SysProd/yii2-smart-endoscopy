...
/* @var $searchModel app\modules\endoscopy\models\search\ToolsCleaningAgentsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Cleaning Agents');
...
?>
<div class="tools-cleaning-agents-index">
...
//        'id',
        ...
        [
            ...
            'value'=>function ($model) {
                /* @var $model app\modules\endoscopy\models\ToolsCleaningAgents */
        ...
        [
            ...
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    ...
                    return Html::a(
                        Icon::show('pencil'),
                        ['/endoscopy/tools-cleaning-agents/update', 'id' => $model->id, 'form' => $model::FORM_TYPE_AJAX, 'returnUrl' => Helper::getReturnUrl()],
                        [
                ...
                'delete' => function ($url, $model) {
                    ...
                    return Html::a(Icon::show('trash'), null, [
                        'data-url' => Url::toRoute(['/endoscopy/tools-cleaning-agents/delete', 'id' => $model->id, 'returnUrl' => Helper::getReturnUrl()]),
    ...
    $button = Html::button(Icon::show('plus-circle'), [
        'value' => Url::toRoute(['/endoscopy/tools-cleaning-agents/update', 'form' => ToolsCleaningAgents::FORM_TYPE_AJAX, 'returnUrl' => Helper::getReturnUrl()]),
        'class' => 'btn btn-' . GridView::TYPE_WARNING . ' btn-sm',
        'title' => \Yii::t('app', 'Add «{attribute}»', ['attribute' => Yii::t('app', 'Cleaning Agent')]),
        'onclick' =>
            '   $("#modal-tools").modal("show")
                                        .find(".modal-header h4").text("' . \Yii::t('app', 'Adding data of «{attribute}»', ['attribute' => Yii::t('app', 'Cleaning Agent')]) . '")
                                        .end()
                                        .find(".modal-body")
    ...
    echo DynaGrid::widget([
        ...
        'gridOptions' => [
            ...
            'panel' => [
                ...
                'heading' => Icon::show('flask') . Html::encode(Yii::t('app', 'General of data')),
                'after' => false,
                'before' => false,
            ],
            'toolbar' => [
...
//                    $buttonRemoveAll .
                    ' ' . Html::button(Icon::show('search'), [
                        'id' => 'ButtonSearch',
                        'value' => Url::toRoute(['/endoscopy/tools-cleaning-agents/search']),
