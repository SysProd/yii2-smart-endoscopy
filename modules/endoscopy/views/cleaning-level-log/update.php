...
if (isset($model->id_disguise)) {
    $label = Yii::t('app', 'Editing of «{attribute}»', ['attribute' => Yii::t('app', 'Cleaning Level Logs')]);
    $small = Yii::t('app', '(No. {item})', ['item' => $model->id]);
} else {
    $label = Yii::t('app', 'Adding of «{attribute}»', ['attribute' => Yii::t('app', 'Cleaning Level Logs')]);
    $small = false;
}
