...
//            'minimumInputLength' => 3,
    ...
    <?= $form->field($model, 'level_1_add')->widget(
        Select2::classname(), [
        'data' => $model->statementsTwoList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_1_add"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_2_test_1')->widget(
        Select2::classname(), [
        'data' => $model->statementsTwoList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_2_test_1"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_3_clear_1')->widget(
        Select2::classname(), [
        'data' => $model->statementsThreeList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_3_clear_1"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_4_test_clear_2')->widget(
        Select2::classname(), [
        'data' => $model->statementsTwoList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_4_test_clear_2"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_5_disinfection_manual')->widget(
        Select2::classname(), [
        'data' => $model->statementsThreeList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_5_disinfection_manual"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_5_disinfection_auto')->widget(
        Select2::classname(), [
        'data' => $model->statementsThreeList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_5_disinfection_auto"),
        ],
    ]); ?>

    <?= $form->field($model, 'level_6_cleaning_tools')->widget(
        Select2::classname(), [
        'data' => $model->statementsTwoList,
        'hideSearch' => true,
        'options' => [
            'placeholder' => ' ...',
            'title' => $model->getAttributeLabel("level_6_cleaning_tools"),
        ],
    ]); ?>

    <?= $form->field($model, 'comment_history')->textInput(['maxlength' => true]) ?>
