...
use app\modules\endoscopy\models\ToolsStatuses;

/* @var $this yii\web\View */
/* @var $searchModel app\modules\endoscopy\models\search\ToolsStatusesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Instrument Statuses');
...
?>
<div class="tools-statuses-index">
...
//        'icon',
        ...
        [
            ...
            'value'=>function ($model) {
                /* @var $model app\modules\endoscopy\models\ToolsStatuses */
        ...
        [
            ...
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    ...
                    return Html::a(
                        Icon::show('pencil'),
                        ['/endoscopy/tools-statuses/update', 'id' => $model->id, 'form' => $model::FORM_TYPE_AJAX, 'returnUrl' => Helper::getReturnUrl()],
                        [
                            'class' => 'activity-view-link',
                            'title' => \Yii::t('app', 'Change data'),
                            'data-toggle' => 'modal',
                            'data-target' => '#modal-statuses',
                            'data-id' => $key,
                            'data-pjax' => '0',
                        ]   );
                },
                'delete' => function ($url, $model) {
                    ...
                    return Html::a(Icon::show('trash'), null, [
                        'data-url' => Url::toRoute(['/endoscopy/tools-statuses/delete', 'id' => $model->id, 'returnUrl' => Helper::getReturnUrl()]),
    ...
    $button = Html::button(Icon::show('plus-circle'), [
        'value' => Url::toRoute(['/endoscopy/tools-statuses/update', 'form' => ToolsStatuses::FORM_TYPE_AJAX, 'returnUrl' => Helper::getReturnUrl()]),
        'class' => 'btn btn-' . GridView::TYPE_WARNING . ' btn-sm',
        'title' => \Yii::t('app', 'Add «{attribute}»', ['attribute' => Yii::t('app', 'Instrument Status')]),
        'onclick' =>
            '   $("#modal-statuses").modal("show")
                                        .find(".modal-header h4").text("' . \Yii::t('app', 'Adding data of «{attribute}»', ['attribute' => Yii::t('app', 'Instrument status')]) . '")
                                        .end()
                                        .find(".modal-body")
    ...
    echo DynaGrid::widget([
        ...
        'gridOptions' => [
            ...
            'panel' => [
                ...
                'heading' => Icon::show('bell') . Html::encode(Yii::t('app', 'General of data')),
                'after' => false,
                'before' => false,
            ],
            'toolbar' => [
...
//                    $buttonRemoveAll .
                    ' ' . Html::button(Icon::show('search'), [
                        'id' => 'ButtonSearch',
                        'value' => Url::toRoute(['/endoscopy/tools-statuses/search']),
...
$titleNameUpdate = \Yii::t('app', 'Editing of «{attribute}»', ['attribute' => Yii::t('app', 'Instrument status')]);
