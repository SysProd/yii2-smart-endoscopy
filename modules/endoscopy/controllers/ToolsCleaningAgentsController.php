...
use app\modules\endoscopy\models\search\ToolsCleaningAgentsSearch;

/**
 * ToolsCleaningAgentsController implements the CRUD actions for ToolsCleaningAgents model.
 */
class ToolsCleaningAgentsController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all ToolsCleaningAgents models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ToolsCleaningAgentsSearch();
    ...
    /**
     * Creates a new ToolsCleaningAgents model.
    ...
    /**
     * Updates an existing ToolsCleaningAgents model.
    ...
    public function actionUpdate($id = null, $form = null, $returnUrl = null)
    {
        if (!is_null($id)) {
            ...
            $model->scenario = ToolsCleaningAgents::SCENARIO_UPDATE;
        } else {
            $model = new ToolsCleaningAgents(['scenario' => ToolsCleaningAgents::SCENARIO_CREATE]);
        }
    ...
    /**
     * Deletes an existing ToolsCleaningAgents model.
    ...
    /**
     * Finds the ToolsCleaningAgents model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ToolsCleaningAgents the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ToolsCleaningAgents::findOne($id)) !== null) {
            return $model;
        }
