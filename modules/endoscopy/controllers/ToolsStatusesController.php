...
use app\modules\endoscopy\models\search\ToolsStatusesSearch;

/**
 * ToolsStatusesController implements the CRUD actions for ToolsStatuses model.
 */
class ToolsStatusesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all ToolsStatuses models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ToolsStatusesSearch();
    ...
    /**
     * Creates a new ToolsStatuses model.
    ...
    /**
     * Updates an existing ToolsStatuses model.
    ...
    public function actionUpdate($id = null, $form = null, $returnUrl = null)
    {
        if (!is_null($id)) {
            ...
            $model->scenario = ToolsStatuses::SCENARIO_UPDATE;
        } else {
            $model = new ToolsStatuses(['scenario' => ToolsStatuses::SCENARIO_CREATE]);
        }
    ...
    /**
     * Deletes an existing ToolsStatuses model.
    ...
    /**
     * Finds the ToolsStatuses model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ToolsStatuses the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ToolsStatuses::findOne($id)) !== null) {
            return $model;
        }
