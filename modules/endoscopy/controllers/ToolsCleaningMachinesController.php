...
use app\modules\endoscopy\models\search\ToolsCleaningMachinesSearch;

/**
 * ToolsCleaningMachinesController implements the CRUD actions for ToolsCleaningMachines model.
 */
class ToolsCleaningMachinesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all ToolsCleaningMachines models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ToolsCleaningMachinesSearch();
    ...
    /**
     * Creates a new ToolsCleaningMachines model.
    ...
    /**
     * Updates an existing ToolsCleaningMachines model.
    ...
    public function actionUpdate($id = null, $form = null, $returnUrl = null)
    {
        if (!is_null($id)) {
            ...
            $model->scenario = ToolsCleaningMachines::SCENARIO_UPDATE;
        } else {
            $model = new ToolsCleaningMachines(['scenario' => ToolsCleaningMachines::SCENARIO_CREATE]);
        }
    ...
    /**
     * Deletes an existing ToolsCleaningMachines model.
    ...
    /**
     * Finds the ToolsCleaningMachines model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ToolsCleaningMachines the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ToolsCleaningMachines::findOne($id)) !== null) {
            return $model;
        }
