...
<div class="shop-stuff-create">
    ...
    <?= $form->field($model, 'password', $fieldOptions1)->passwordInput(['autofocus' => true, 'placeholder'=>$model->getAttributeLabel('password')])->label(true) ?>

    <?= $form->field($model, 'password_repeat', $fieldOptions2)->passwordInput(['placeholder'=>$model->getAttributeLabel('password_repeat')])->label(true) ?>
    ...
    <div class="box-footer">
        <div class="pull-right">
            <?= Html::submitButton(Icon::show('save', ['class' => 'fa-lg']).\Yii::t('app', 'Edit').' «'.\Yii::t('app', 'Password').'»', ['class' => 'btn btn-primary', 'name' => 'action', 'value' => 'save',]) ?>
        </div>
    </div>
